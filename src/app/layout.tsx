...
const brand: BrandConfig = {
  ...
  navLinks: [{ label: 'Start learning', href: '/' }, { label: 'Structured Lesson', href: '/lesson' }, { label: 'Learning Path', href: '/path' }, { label: 'Conversation', href: '/converse' }, { label: 'Languages', href: '/?tab=languages' }],
